...
/**
 * <h1>PlaceShip</h1>
 * The PlaceShip class allows for the user, or AI, to place their ships on the 
 * board
 */
public class PlaceShip {
     ...
     * @param size - int that holds the size of the row/col
     ...
     * @param row - int that holds number of rows
     * @param col - int that holds number of columns
     * @param size - int that holds the size of the row/col, dir - boolean
